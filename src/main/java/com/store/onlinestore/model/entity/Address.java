...
//    @Pattern(regexp = "^{5,30}$",message = "Invalid Region Name")
    private String regionName;
    @Column(name = "street", length = 150)
//    @Pattern(regexp = "^{5,150}$",message = "Invalid Street Name")
    private String streetName;
    @Column(name = "plates", length = 5)
//    @Pattern(regexp = "^[a-zA-Z0-9&\\_\\-\\s]{5}$",message = "Invalid Plates Number")
...
//    @Pattern(regexp = "^[0-9]{10}$",message = "Invalid Postal Code")
    ...
    public String getFullAddress() {
        String fullAddress = countryName + " - " + stateName + " - " + cityName + " - " + villageName + " - " + regionName
